...
-- Listage des données de la table sakura.sakura_category : ~1 rows (environ)
...
-- Listage des données de la table sakura.sakura_comment : ~13 rows (environ)
INSERT INTO `sakura_comment` (`Id`, `Content`, `Status`, `Comment_Post_Id`, `Author`, `Email`, `Date_Created`, `nombre_signalement`) VALUES
	...
	(6, 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam omnis nostrum qui dicta eius sit quas ex aperiam accusamus provident numquam deleniti, fugit quia ratione mollitia nemo nam dolore hic!', 'approved', 1, '', '', '2023-01-03 00:00:00', 1),
...
-- Listage des données de la table sakura.sakura_stats : ~29 rows (environ)
INSERT INTO `sakura_stats` (`Id`, `Session`, `Date`) VALUES
	...
	(27, 'l0dpavs5527n7a7m1c1qall9ua', '2023-01-04'),
...
INSERT INTO `sakura_user` (`Id`, `Firstname`, `Lastname`, `Email`, `Password`, `Status`, `Role`, `Token`) VALUES
	(1, 'Makan', 'KAMISSOKO', 'makan.kamissoko@hotmail.fr', '$2a$12$WlDnoGROaol0bdKUe5cxJOBX2BFJPsewOXo12nIeEIy02Bm/Wacvq', 1, 0, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.WyJNYWthbiIsIktBTUlTU09LTyIsIm1ha2FuLmthbWlzc29rb0Bob3RtYWlsLmZyIl0=.cd610801d0dcf3f3461412ef80f026e5037a7b70f3f6c0b6f656099c1d485697.63b5a6eb654b6'),
