...
--
-- Hôte : database
-- Généré le : mar. 01 nov. 2022 à 14:30
...
--
CREATE DATABASE IF NOT EXISTS `sakura` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sakura`;
...
INSERT INTO `sakura_article` (`Id`, `Content`, `Slug`, `User_Id`, `Image_Name`) VALUES
(1, 'Unspecified atherosclerosis of autologous vein bypass graft(s) of the extremities, other extremity.\r\n\r\nLorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam vel libero nec metus lobortis commodo. Suspendisse id maximus metus, ut cursus nunc. Nullam at libero eleifend, convallis lectus id, elementum lorem. Nulla augue tellus, facilisis id ultricies et, fringilla ut erat. Pellentesque et rhoncus arcu. Vivamus ac est pulvinar nisi fermentum consequat eu a massa. Aenean malesuada quam eget nulla pharetra finibus. Vestibulum mollis malesuada nulla, quis cursus neque maximus non. Morbi eu luctus massa.\r\n\r\n', 'Double Indemnity', 1, ''),
