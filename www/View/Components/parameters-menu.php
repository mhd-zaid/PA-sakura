<nav id="parameters-nav">
    ...
    <div class="container">
        ...
        <h1>Communication</h1>
        <ul>
            <li class="choices-parameters"><a href="/parametres-notifications"><img src="Public/img/Back/notification1.svg" alt="Notification"><button class="cta-button btn--white-rounded">Notification</button></a></li>
        </ul>
        <h1>Aide</h1>
        <ul>
            <li class="choices-parameters"><a href="/parametres-support"><img src="Public/img/Back/help1.svg" alt="Support">Support</a></li>
            <li class="choices-parameters"><a href="/parametres-cgu"><img src="Public/img/Back/cgu1.svg" alt="CGU">CGU</a></li>
        </ul>
	</div>
</nav>