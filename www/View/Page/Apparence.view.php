...
<section class="body">
            ...
            <div class="col">
                <nav class="nav row">
                    <ul style="display : flex">
                        <div class="col">
                            <li style="list-style : none">Page 1</li>
                        </div>
                        <div class="col">
                            <li style="list-style : none">Page 2</li>
                        </div>
                        <div class="col">
                            <li style="list-style : none">Page 3</li>
                        </div>
                        <div class="col">
                            <li style="list-style : none">Page 4</li>
                        </div>
                    </ul>
                </nav>
            </div>
    ...
    <section style="padding: 0px 50px;">
        <h1 class="titre">Apparence H1</h1>
        <h2 class="titre">Apparence H2</h2>
        <h3 class="titre">Apparence H3</h3>
        <p class="paragraph">Paragraphe</p>
    </section>
